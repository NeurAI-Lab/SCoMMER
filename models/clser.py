...
class CLSER(ContinualModel):
    ...
    def end_task(self, dataset) -> None:
        ...
        torch.save(self.stable_model, os.path.join(model_dir, f'task_{self.current_task}_stable_model.ph'))
        torch.save(self.plastic_model, os.path.join(model_dir, f'task_{self.current_task}_plastic_model.ph'))
