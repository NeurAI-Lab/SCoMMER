...
class MyMNIST(MNIST):
    ...
    def __init__(self, root, train=True, transform=None,
        ...
        self.not_aug_transform = transforms.Compose((transforms.ToTensor(), transforms.Normalize((0.13062755,), (0.30810780,))))
...
class SequentialMNIST(ContinualDataset):
    ...
    def get_data_loaders(self):
        # transform = transforms.ToTensor()
        transform = transforms.Compose((transforms.ToTensor(), transforms.Normalize((0.13062755,), (0.30810780,))))
