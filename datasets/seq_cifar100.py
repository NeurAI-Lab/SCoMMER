...
class SequentialCIFAR100(ContinualDataset):
    ...
    def __init__(self, args: Namespace) -> None:
        ...
        SequentialCIFAR100.N_TASKS = args.cifar100_num_tasks
        SequentialCIFAR100.N_CLASSES_PER_TASK = 100 // args.cifar100_num_tasks
        print(f'Setting the Number of tasks to {SequentialCIFAR100.N_TASKS} with {SequentialCIFAR100.N_CLASSES_PER_TASK} classes each')
